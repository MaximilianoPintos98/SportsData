  ...
  return isLoading ? (
    ...
    <div className="card">
      {jsonData2.map((jd, idx) => {
        ...
        {if (jd[1][0].league.round.search('Group Stage') === 0) {
          ...
          return (
            <div key={idx}>
              ...
              <div className="row row-cols-1 row-cols-md-2 g-2 ">
                {jd[1].map((d, i) => {
                  var dateMatch = new Date(d.fixture.timestamp * 1000).toLocaleDateString();
                  var timeMatchComplete = new Date(d.fixture.timestamp * 1000).toLocaleTimeString();
                          ...
                          <div className="border-end border-dark col-8 customText">
                            <div className="d-flex">
                              ...
                              <div className="col pt-2 text-center">
                                <span>{d.goals.home ? d.goals.home : (d.goals.home === 0) ? "0" : "-"}</span>
                              </div>
                            </div>
                            <div className="d-flex">
                              <div className="col pt-2">
                              ...
                              <div className="col pt-2 text-center">
                                <span>{d.goals.away ? d.goals.away : (d.goals.away === 0) ? "0" : "-"}</span>
                              </div>
                            </div>
                          </div>
                          <div className="col-4">
